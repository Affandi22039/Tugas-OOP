public class TestPoint {
    public static void main(String[]args){
        ...
        p2.setXY (10,11);
        System.out.printf("Jaraknya adalah: %.2f%n", p1.jarak(11, 11));
        System.out.printf("Jaraknya adalah: %.2f%n", p1.jarak(p2));
        System.out.printf("Jaraknya adalah: %.2f%n", p2.jarak(p1));
        System.out.printf("Jaraknya adalah: %.2f%n", p1.jarak());
