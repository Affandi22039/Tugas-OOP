public class Point {
    ...
    // membuuat instance point dengan nilai default
    ...
    //mengembalikan jarak dari instance ini ke titk (x,y) yang diberikan. dipanggil dengan p1.jarak (1,2)
    ...
    //mengembalikan jarak dari instance ini ke instansi titik lainnya  dipanggil dengan p1.jarak (p2)
    ...
    //mengembalikan jaak dari instance ke titik (0,0) dipanggil dengan p1.jarak ()
    public double jarak(){
